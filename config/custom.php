...
return [
    'custom' => [
        ...
        'templateTitle' => 'MyCollection', //template Title can be changes default('Materialize)
        ...
        'defaultLanguage'=>'cz',    //en(default)/de/pt/fr here are four optional language provided in theme
    ],
];
